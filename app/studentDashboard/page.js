    ...
    <div className="page-container">
        <div className="container mx-auto px-4 max-w-6xl">
            <div className="page-header animate-slide-up">
                ...
                <p className="page-subtitle">Welcome back, {studentData.FirstName}</p>
            </div>
            ...
            <div className="mb-4">
                <h2 className="text-lg font-semibold text-[var(--text-secondary)]">Enrolled Courses</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in">
                {courses.map((course) => (
                    <Link
                        href={`/studentDashboard/${course._id}`}
                        key={course.CourseID}
